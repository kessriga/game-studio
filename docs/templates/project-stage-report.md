...
**Current Focus**: [What the project is actively working on] **Blocking Issues**: [Critical gaps preventing progress]
...
1. **[Action 3]** — [Why it's important soon]
2. **[Action 4]** — [Why it's important soon]

### Medium-Term (Next Milestone)

1. **[Action 5]** — [Future need]
2. **[Action 6]** — [Future need]
...
- `/skill:gamedev-reverse-document [type] [path]` — [For which gap]
- `/skill:gamedev-architecture-decision` — [For which gap]
- `/skill:gamedev-create-epics` → `/skill:gamedev-create-stories` — [If the Backlog board has no work items yet]
...
*Generated by `/skill:gamedev-project-stage-detect` skill*

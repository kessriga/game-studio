# Example Session: Full Story Lifecycle — /gamedev:story-readiness → Implement → /gamedev:story-done

**Context:** Solo indie dev, mid-production. The movement system GDD and architecture are complete. A story for movement's core implementation has been generated by `/gamedev:create-stories`, which also minted its Backlog task.
...
**Turns:** 13
**Outcome:** Story validated ready, implemented, verified complete with `/gamedev:story-done`
...
**User:**
> /gamedev:story-readiness production/epics/movement/story-001-movement.md

### Turn 2: Agent Validates the Story

**Agent (via /gamedev:story-readiness):**
...
### Turn 10: User Tests Manually and Runs /gamedev:story-done

**User:**
> I've tested it in the scene — everything works. /gamedev:story-done production/epics/movement/story-001-movement.md

### Turn 11: Agent Runs Completion Review

**Agent (via /gamedev:story-done):**
...
>
> Suggest running `/gamedev:code-review src/gameplay/movement/` before marking complete. Not blocking.
>
> ---
...
>
> Run `/gamedev:story-readiness` on whichever you pick up next.

---

## What This Example Demonstrates

- **Readiness gate catches real issues**: the roll direction ambiguity would have caused a late implementation decision without `/gamedev:story-readiness`
...
- **Deferred criteria**: not every acceptance criterion can be verified at story close — `/gamedev:story-done` tracks deferred items rather than blocking completion

...
**Claude model metadata:** Fable (top-2 authority — highest-judgment architecture and phase-gate verdicts).
...
- [ ] Claude model metadata is `claude-fable-5` per docs/claude-code.md (top-2 director → Fable)

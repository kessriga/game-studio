...
5. Skill asks "May I write to `production/qa/qa-plan-Combat-System-[date].md`?"
...
4. Skill asks "May I update `production/qa/qa-plan-Combat-System-[date].md`?" (not overwrite)

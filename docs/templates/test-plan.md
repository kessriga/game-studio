...
> **Date**: [date] **Generated by**: /skill:gamedev-qa-plan **Scope**: [N stories across N systems] **Engine**: [engine
> name and version] **Sprint file**: [path to sprint plan]
...
**Verification method**: Screenshot + [designer / art-lead] sign-off **Evidence file**:
`production/qa/evidence/[story-slug]-evidence.md` **Who must sign off**: [designer / lead-programmer / art-lead]
...
**Verification method**: Manual step-through **Evidence file**: `production/qa/evidence/[story-slug]-evidence.md`
...
Critical paths to verify before QA hand-off (run via `/skill:gamedev-smoke-check`):
...
- [ ] Smoke check passes (run `/skill:gamedev-smoke-check sprint` before QA hand-off)
...
*Results and sign-off are tracked in the QA sign-off report generated by `/skill:gamedev-team-qa` — not in this plan
file.*

*Template: `./test-plan.md`* *Generated by: `/skill:gamedev-qa-plan` — do not edit this line*

...
**Status**: Reverse-Documented **Source**: `[path to implementation code]` **Date**: [YYYY-MM-DD] **Decision Makers**:
[User name or "inferred from code"]
**Implementation Status**: [Deployed | Partial | Planned]
---

> **⚠️ Reverse-Documentation Notice**
>
> This Architecture Decision Record was created **after** the implementation already existed. It captures the current
> implementation approach and clarified rationale based on code analysis and user consultation. Some context may be
> reconstructed rather than contemporaneously documented.
...
*This ADR was generated by `/skill:gamedev-reverse-document architecture [path]`*

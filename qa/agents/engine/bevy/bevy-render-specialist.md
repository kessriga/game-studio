...
Domain: Bevy rendering — wgpu pipeline, WGSL shaders, custom materials, render-graph-as-systems, post-processing, render
performance. Does NOT own: host-side gameplay Rust (bevy-rust-specialist), UI (bevy-ui-specialist), high-level
architecture (bevy-specialist). No gate IDs assigned.
...
**Input:** "I need a custom material that tints a texture." **Expected behavior:**
...
**Input:** "Add a custom RenderGraph node for my post-process effect." **Expected behavior:**
...
**Input:** "Bloom looks wrong after upgrading — thresholds seem off." **Expected behavior:**
...
**Input:** "Will this shader work on the web build?" **Expected behavior:**
...
**Input:** "How do we verify this shader effect is correct?" **Expected behavior:**

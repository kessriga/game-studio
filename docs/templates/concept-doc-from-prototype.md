...
**Status**: Reverse-Documented from Prototype **Prototype Path**: `prototypes/[name]/` **Date**: [YYYY-MM-DD]
**Creator**: [User name]
...
>
> This concept document was created **after** the prototype was built. It captures the core mechanic, learnings, and
> design insights discovered through prototyping. This is a formalization of experimental work, not a pre-planned
> design.
...
**Original Hypothesis**: [What question or idea was this prototype testing?]

**Approach**: [How was the prototype built? Quick and dirty? Focused on one mechanic?]
...
**What the Prototype Does**: [Describe the mechanic or system that was prototyped]
...
**Player Fantasy**: [What fantasy or experience does this mechanic create?]
...
*This concept document was generated by `/skill:gamedev-reverse-document concept prototypes/[name]`*

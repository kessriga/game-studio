...
Use the ADR template linked from gamedev's architecture-decision skill in the installed plugin.

**Required sections:** Title, Status, Context, Decision, Consequences, ADR Dependencies, Engine Compatibility, GDD
...
Version-pinned engine API snapshots. **Always check here before using any engine API** — the LLM's training data

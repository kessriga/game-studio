...
- `gamedev:performance-analyst` — Profiling, optimization, memory analysis
- `gamedev:engine-programmer` — Engine-level fixes for rendering, memory, resource loading
- `gamedev:technical-artist` — VFX polish, shader optimization, visual quality
- `gamedev:sound-designer` — Audio polish, mixing, ambient layers
- `gamedev:tools-programmer` — Content pipeline and editor tool verification
- `gamedev:qa-tester` — Edge case testing, regression testing, soak testing
...
All file writes (performance reports, test results, evidence docs) are delegated to sub-agents spawned through

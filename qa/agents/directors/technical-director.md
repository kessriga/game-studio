...
**Model tier:** Fable (top-2 authority — highest-judgment architecture and phase-gate verdicts).
...
- [ ] Model tier is `claude-fable-5` per coordination-rules.md (top-2 director → Fable)

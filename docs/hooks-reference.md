...
| `validate-skill-change.sh` | PostToolUse (Write/Edit) | Skill file changes | Advises running `/gamedev:skill-test` after any `.claude/skills/` file is written or edited |

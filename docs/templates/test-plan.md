...
Critical paths to verify before QA hand-off (run via `/gamedev:smoke-check`):
...
- [ ] Smoke check passes (run `/gamedev:smoke-check sprint` before QA hand-off)
...
*Results and sign-off are tracked in the QA sign-off report generated by `/gamedev:team-qa` — not in this plan file.*

*Template: `./test-plan.md`*
*Generated by: `/gamedev:qa-plan` — do not edit this line*

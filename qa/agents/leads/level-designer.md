...
**Claude model metadata:** Sonnet (individual system analysis — level design review and encounter assessment).
...
- [ ] Claude model metadata is Sonnet (floating alias) per docs/claude-code.md

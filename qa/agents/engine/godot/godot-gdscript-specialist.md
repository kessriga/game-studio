...
Domain: GDScript static typing, design patterns in GDScript, signal architecture, coroutine/await patterns, and GDScript
performance. Does NOT own: shader code (godot-shader-specialist), GDExtension bindings (godot-gdextension-specialist).
...
- Explicitly states that shader authoring belongs to `gamedev:godot-shader-specialist`
- Redirects the request to `gamedev:godot-shader-specialist`
...
**Input:** Engine version context provided: Godot 4.6. Request: "Create an abstract base class for all enemy types using
@abstract." **Expected behavior:**
